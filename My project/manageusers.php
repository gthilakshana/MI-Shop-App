...
<head>
    ...
    <title>MI SHOP | Admin | Manage Users</title>
            ...
            ?>
                ...
                <div class="col-12 mb-3">
                    <div class="row">
                        ...
                        <div class="col-4 col-lg-2 bg-warning">
                            <span class="fs-6 fw-bold text-dark"><?php echo $user_data["fname"] . " " . $user_data["lname"]; ?></span>
                        </div>
                        <div class="col-4 col-lg-2 bg-light py-2 d-lg-block">
                            <span class="fs-6 fw-bold"><?php echo $user_data["email"]; ?></span>
                        </div>
                        <div class="col-2 bg-warning py-2 d-none d-lg-block">
                            <span class="fs-6 fw-bold text-dark"><?php echo $user_data["mobile"]; ?></span>
                        </div>
                        <div class="col-2 bg-light py-2 d-none d-lg-block">
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button class="btn btn-dark" onclick="userBlock('<?php echo $user_data['email']; ?>');">Block</button>
                            <?php

                            } else {

                            ?>
                                <button class="btn btn-warning" onclick="userBlock('<?php echo $user_data['email']; ?>');">Unblock</button>
                            <?php
