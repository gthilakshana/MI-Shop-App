...
<head>
    <title>MI SHOP |Advance Search</title>
...
<body >
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-body border border-dark border-start-0 border-end-0 border-top-0">
                ...
                <div class="row">
                    <div class="offset-0 offset-lg-4 col-12 col-lg-4">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <label class="text-dark fw-bold fs-2 mt-4">Advanced Search</label>
                            </div>
                    ...
                    <div class="offset-0 offset-lg-1 col-12 col-lg-10">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-2 mt-3 mb-2 d-grid">
                                <button class="btn btn-warning search-btn1" onclick="advancedSearch(0);">Search</button>
                            </div>
            ...
            <div class="offset-lg-2 col-lg-8 bg-white rounded mb-3">
                <div class="row">
                    <div class="offset-8 col-4">
                        <select class="form-select border-0 border-bottom border-dark border-3" id="sort">
                    ...
                    <div class="offset-0 offset-lg-1 col-12 col-lg-10 text-center">
                        <div class="row">
                            ...
                            <div class="offset-5 col-2 mt-5">
                                <span class="text-black-50"><i class="bi bi-search fs-1"></i></span>
                            </div>

                            <div class="offset-3 col-6 mb-5 mt-5">
