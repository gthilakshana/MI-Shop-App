        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-4 col-lg-2 bg-warning">
            ...
            ?>
                <div class="col-12 mb-3">
                    <div class="row">
                        ...
                        <div class="col-4 col-lg-2 bg-warning">
                            <span class="fs-6 fw-bold text-dark"><?php echo $product_data["title"]; ?></span>
                        </div>
                        <div class="col-4 col-lg-2 bg-light py-2 d-lg-block">
                            <span class="fs-6 fw-bold">Rs. <?php echo $product_data["price"]; ?> .00</span>
                        </div>
                        <div class="col-2 bg-warning py-2 d-none d-lg-block">
                            <span class="fs-6 fw-bold text-dark"><?php echo $product_data["qty"]; ?></span>
                        </div>
                        <div class="col-2 bg-light py-2 d-none d-lg-block">
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button class="btn btn-warning" onclick="productBlock('<?php echo $product_data['id']; ?>');">Block</button>
                            <?php

                            } else {

                            ?>
                                <button class="btn btn-primary" onclick="productBlock('<?php echo $product_data['id']; ?>');">Unblock</button>
                            <?php
...
<div class="col-12 text-center">
    <h3 class="text-light fw-bold">Manage Category</h3>
</div>
...
<div class="col-12 mb-3">
    <div class="row g-2">
        ...
        ?>
            ...
            <div class="col-12 col-lg-3 border border-dark bg-warning" style="height: 50px;">
        ...
        <div class="col-12 col-lg-3 border border-light ms-2" style="height: 50px;">
            <div class="row g-1 px-1">

                <div class="col-8 mt-2">
                    <label class="form-label fw-bold fs-4 text-light">Add New Category</label>
                </div>
                <div class="col-4 border-start border-light text-center mt-2" onclick="addnewcategory();">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-dark" onclick="categoryVerifyModal();">Add Category</button>
                    </div>
                </div>
            </div>
        </div>
