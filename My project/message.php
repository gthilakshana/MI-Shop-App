                    ...
                    <div class="col-12 col-lg-5 px-0">
                        <div class="bg-white">
                            ...
                            <div class="col-12">
                                ...
                                $message_rs = Database::search("SELECT DISTINCT `from`,`content`,`date_time`,`status` FROM `message` 
                                WHERE `to`='" . $e . "' ORDER BY `date_time`");
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="me-4">
                                                                    <div class="d-flex align-items-center justify-content-between mb-1">
                                                                        <h6 class="mb-0"><?php echo $user_data["fname"] ?></h6>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button id="sendbtn" class="btn btn-link fs-2 bg-dark" onclick="sendMsg();"><i class="bi bi-send-fill"></i></button>
                                    </div>
