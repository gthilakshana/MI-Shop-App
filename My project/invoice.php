                    ...
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-12 text-end fw-bold">
                                <span>No 21/4 Colombo Road, Matara</span> <br />
                                <span>070 3985 224</span> <br />
                                <span>mishop@gmail.com</span>
                            </div>
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                `city` ON user_has_address.city_id=city.id  WHERE `user_email`='" . $_SESSION["u"]["email"] . "'");
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr style="height: 72px;">
                                    ...
                                    <td class="fs-6 text-end bg-primary text-white"><?php echo $order_data["qty"] ?></td>
                                    <td class="fs-6 text-end pt-3">Rs. <?php echo $order_data["total"] ?> .00</td>
                                </tr>
                            </tbody>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end border-primary text-primary fs-5 fw-bold">Rs. <?php echo $order_data["total"] - $discount ?> .00</td>
                                </tr>
